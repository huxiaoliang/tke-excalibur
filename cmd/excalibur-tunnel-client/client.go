...
func (o *GrpcProxyClientOptions) Flags() *pflag.FlagSet {
	...
	flags.StringVar(&o.kubeConfig, "kubeconfig", o.kubeConfig, "Path to the kubeconfig file.")
...
func (c *Client) listPod(client *kubernetes.Clientset) error {
